...
Write-Host "`n[2/2] Running Phase 2 DoD checks..." -ForegroundColor Yellow
python -c @"
import asyncio
import json
from backend.app.services.phase2_validator import run_phase2_validation

report = asyncio.run(run_phase2_validation())
...
Write-Host "`nAll Phase 2 checks passed." -ForegroundColor Green
